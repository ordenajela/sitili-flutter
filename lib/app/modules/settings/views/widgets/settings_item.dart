  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      trailing: isDark
          ...
          : InkWell(
              onTap: () {
                // Navegar a la vista de perfil al hacer clic
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ProfileScreen()), // Reemplaza ProfileScreen() con el nombre correcto de tu vista de perfil
                );
              },
              child: Container(
                width: 40.w,
